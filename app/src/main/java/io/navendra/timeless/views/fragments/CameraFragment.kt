...
class CameraFragment : Fragment(), View.OnClickListener, ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    /**
     * An [FullScreenTextureView] for camera preview.
     */
    private var mTextureView: FullScreenTextureView? = null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        mTextureView = view.findViewById<View>(R.id.textureView) as FullScreenTextureView
    }
